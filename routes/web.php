...
Route::middleware('auth:admin')->group(function () {
    ...
    Route::group(['prefix' => 'dashboard'], function () {
        ...
        Route::post('export-excel-order-details', [DashboardController::class, 'exportExcelForOrderDetails'])
            ->name('dashboard.export.excel.order.details');
        Route::post('export-excel-best-selling-products', [DashboardController::class, 'exportExcelForBestSellingProducts'])
            ->name('dashboard.export.excel.best.selling.products');
    });

    Route::group(['prefix' => 'catalog/brand'], function () {
        Route::get('', [BrandController::class, 'index'])
            ->name('catalog.brand.index');
    ...
    Route::group(['prefix' => 'manage/customer'], function () {
        Route::get('', [CustomerController::class, 'index'])
            ->name('manage.customer.index');
        Route::put('/update-disable-flag/{customerId}', [CustomerController::class, 'updateDisableFlag'])
            ->name('manage.customer.update-disable-flag');
        Route::delete('/delete/{customerId}', [CustomerController::class, 'delete'])
            ->name('manage.customer.delete');
        Route::get('/search', [CustomerController::class, 'search'])
            ->name('manage.customer.search');
        Route::get('/details/{customerId}', [CustomerController::class, 'showDetails'])
            ->name('manage.customer.details');
    });
